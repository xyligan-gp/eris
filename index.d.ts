...
declare namespace Eris {
	...
	> {
		...
		descriptionLocalizations?: U extends Constants['ApplicationCommandTypes']['CHAT_INPUT']
			? Partial<Record<LocaleStrings, string>> | null
			: null;
		dmPermission?: T extends true ? never : boolean | null;
		name?: string;
		nameLocalizations?: Partial<Record<LocaleStrings, string>> | null;
		nsfw?: boolean;
	...
	interface ApplicationRoleConnectionMetadata {
		description: string;
		description_localizations?: Partial<Record<LocaleStrings, string>>;
		key: string;
		name: string;
		name_localizations?: Partial<Record<LocaleStrings, string>>;
		type: ApplicationRoleConnectionMetadataTypes;
	}
	...
	interface DiscoveryCategory {
		...
		name: {
			default: string;
			localizations?: Partial<Record<LocaleStrings, string>>;
		};
	}
